    ...
    <div style={{ display: 'flex', gap: '2px' }}>
      {[1, 2, 3, 4, 5].map((star) => (
        <Star
          ...
          color={star <= rating ? '#D4AF37' : '#555555'}
        />
      ))}
    </div>
  )
          ...
          {filtered.map((item) => (
            ...
            >
              ...
              <div style={{ padding: '16px' }}>
                <h3 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '16px', fontWeight: '700', color: '#F5F5F5', marginBottom: '8px' }}>
                  {item.title}
                </h3>
                <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: '13px', color: '#F5F5F5', opacity: 0.6, marginBottom: '10px' }}>
                  {item.description}
                </p>
          ...
          >
            ...
            <div style={{ padding: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                <h2 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '22px', fontWeight: '700', color: '#F5F5F5' }}>
                  {selectedPhoto.title}
                </h2>
                <span style={{ backgroundColor: '#D4AF37', color: '#111111', fontFamily: 'Poppins, sans-serif', fontSize: '12px', fontWeight: '700', padding: '4px 12px', borderRadius: '4px' }}>
                  {selectedPhoto.category}
                </span>
              </div>
              <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', color: '#F5F5F5', opacity: 0.7, marginBottom: '16px' }}>
