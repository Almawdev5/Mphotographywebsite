...
const testimonials = [
  {
    quote: 'Professional service and amazing photo quality.',
    name: 'Client 1',
    service: 'Wedding Photography',
  },
  {
    quote: 'Very creative and easy to work with.',
    name: 'Client 2',
    service: 'Portrait Photography',
  },
  {
    quote: 'High-quality editing and fast delivery.',
    name: 'Client 3',
    service: 'Photo Editing',
  },
  {
    quote: 'Highly recommended for events and graduation shoots.',
    name: 'Client 4',
