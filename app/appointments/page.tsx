      ...
      <section style={{ padding: '80px 24px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px' }}>
          ...
          <div>
            ...
            {/* Contact Quick Info */}
            <div style={{ backgroundColor: '#2B2B2B', border: '1px solid #333333', borderRadius: '8px', padding: '24px', marginTop: '16px' }}>
              <h3 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '16px', fontWeight: '700', color: '#D4AF37', marginBottom: '16px' }}>
                Need Help?
              </h3>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                <label style={labelStyle}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <Phone size={13} color="#D4AF37" /> Phone Number *
                  </span>
                </label>
                <input type="tel" required placeholder="+251 XXX XXX XXX"
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div>
                  <label style={labelStyle}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <Calendar size={13} color="#D4AF37" /> Preferred Date *
                    </span>
                  </label>
                ...
                <div>
                  <label style={labelStyle}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <Clock size={13} color="#D4AF37" /> Preferred Time *
                    </span>
                  </label>
                  <select required
              ...
              <div>
                <label style={labelStyle}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <MapPin size={13} color="#D4AF37" /> Location
                  </span>
                </label>
                <input type="text" placeholder="Where should we meet? (optional)"
              ...
              <div>
                <label style={labelStyle}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <FileText size={13} color="#D4AF37" /> Additional Notes
                  </span>
                </label>
                <textarea placeholder="Any special requests or details..." rows={4}
